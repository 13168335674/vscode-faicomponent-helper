...
import {App, FaicomponentCompletionItemProvider, FaicomponentDocsContentProvider} from './app';
...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "vscode-faicomponent-helper" is now active!');
    let app = new App();
    app.setConfig();
	let docs = new FaicomponentDocsContentProvider();
	let completionItemProvider = new FaicomponentCompletionItemProvider();
	let registration = vscode.workspace.registerTextDocumentContentProvider('faicomponent-helper', docs);
	...
	let disposable = vscode.commands.registerCommand('faicomponent-helper.search', () => {
        // if (context.workspaceState.get('faicomponent-helper.loading', false)) {
